...
global.gurl = 'https://instagram.com/' // _firstcommenter
global.devs = '2349132095836';
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'THE CURLYHAIRGUY',
  ...
  ownername:process.env.OWNER_NAME || 'CurlyHairGuy',
  sessionName: process.env.SESSION_ID || 'PUT-HERE',
  author: process.env.PACK_INFO.split(";")[0] || 'author', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'true',
  packname: process.env.PACK_INFO.split(";")[1] || 'Name',
  autoreaction: process.env.AUTO_REACTION || 'on',
  antibadword : process.env.ANTI_BAD_WORD || ',huth,huththa,huththo,hukanna,pakaya,pako,ponnaya,ponnayo,kariya,kariyo,huththaa,hutta',
  alwaysonline: process.env.ALWAYS_ONLINE || 'true',
  antifake : process.env.FAKE_COUNTRY_CODE || '233',
  ...
  BRANCH: 'main',
  ALIVE_MESSAGE: process.env.ALIVE_MESSAGE || 'i am alive and a GOD',
